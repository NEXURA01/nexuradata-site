...
1. [business.google.com](https://business.google.com) → connexion avec `admin@nexuradata.ca`
...
1. [console.cloud.google.com](https://console.cloud.google.com) → créer projet **nexuradata-seo-bot**
...
1. [github.com/NEXURA01/nexuradata-site/settings/secrets/actions](https://github.com/NEXURA01/nexuradata-site/settings/secrets/actions) → **New repository secret**
