...
function bodyFr(city) {
    ...
    const desc =     ✅ /recuperation-donnees-laval        → 200
    ✅ /recuperation-donnees-brossard     → 200
    ✅ /recuperation-donnees-longueuil    → 200 (déjà testé)
    ✅ /comment-choisir-recuperation-donnees-montreal → 200
    ✅ /en/recuperation-donnees-laval     → 200.slice(0, 158);
...
const cities = [
    ...
    },
    {
        ...
        localCasesEn: [
            'NVMe SSD from an Old Longueuil design studio — InDesign projects