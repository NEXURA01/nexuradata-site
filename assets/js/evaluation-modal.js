...
(function () {
    ...
    var STYLES = [
        ...
        ".nx-eval-eyebrow{font-family:'IBM Plex Mono',ui-monospace,monospace;font-size:.7rem;letter-spacing:.18em;text-transform:uppercase;color:var(--color-text-muted,#c9c4b8);margin:0 0 10px}",
        ...
        ".nx-eval-field input:focus,.nx-eval-field textarea:focus{outline:none;border-color:var(--color-accent,#c9c4b8);box-shadow:0 0 0 3px rgba(232,228,220,.12)}",
        ...
        ".nx-eval-consent input{margin-top:3px;flex-shrink:0;accent-color:var(--color-accent,#c9c4b8);width:16px;height:16px}",
